...
subtitle: "Charlene BRUNO, Loic CHEONG \n Pierre PHILBERT, SORY Anas"
...
<h3> A project to get through Airbnb's dataset and visualize them. </h3>
...
The aim of the project is to show differents aggregations of differents data types relatively to :
- Room Type
- Number of bedrooms
- Neighborhood
- Dates
